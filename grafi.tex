...
Se il grafo completo ha $n$ vertici allora è detto grafo~$k_n$.
\end{defn}
\begin{ese}
    In Figura~\ref{fig:completi} sono rappresentati 3 grafi completi.\marginpar{
        Nell'ordine:
        \begin{itemize}
            \item un grafo $k_3$
            \item un grafo $k_4$
...
Un grafo è \emph{bipartito} se i suoi vertici sono partizionati in due sottoinsiemi, $U$ e $V$,
e ogni suo spigolo è incidente in un vertice di $U$ ed uno di $V$.
\end{defn}
...
\li \id{C} $\leftarrow v$ \Comment{prendo $v$ e lo metto nell'insieme $C$ }
\li \Comment{Adesso si esaminano tutti i nodi nella componente connessa}
\li \li \li
\Do
\li
\li
