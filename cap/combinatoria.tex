...
\begin{ese}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\item \underline{\bcancel{e}} \underline{e} \underline{ } \quad{ } per il principio di
			moltiplicazione ci sono $5 \cdot 6 = 30$ scelte. 
			\item \underline{\bcancel{e}} \underline{\bcancel{e}} \underline{e} \quad{} per il principio
...
\begin{defn}[r-permutazione]
	Dati $r, n \in \mathbb{N}$ con $r \leq n$, una r-permutazione %di $n$ oggetti distinti,
	%è una disposizione (o ordinamento) degli $n$ oggetti corrispondente ad una ennupla ordinata.
	%\begin{center}
	%	\centering
	%	\#{}permutazioni = $P(n,n) \eqdef n \cdot (n - 1) \cdot \ldots \cdot 1 = n!$ con $0! \eqdef 1$
